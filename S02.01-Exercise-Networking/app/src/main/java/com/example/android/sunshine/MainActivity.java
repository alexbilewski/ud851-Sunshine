...
public class MainActivity extends AppCompatActivity {
    ...
    public class ForecastQueryTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            URL forecastRequestUrl = NetworkUtils.buildUrl(location);

            try {
                String forecastResponse = NetworkUtils.getResponseFromHttpUrl(forecastRequestUrl);

                String[] simpleJsonForecastData = OpenWeatherJsonUtils
                        .getSimpleWeatherStringsFromJson(MainActivity.this, forecastResponse);
                return simpleJsonForecastData;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
        ...
        protected void onPostExecute(String[] forecastData) {
            if (forecastData != null && !forecastData.equals("")) {
                for (String forecastString : forecastData) {
                    mWeatherTextView.append((forecastString) + "\n\n\n");
                }
            }
        }
    }
